...
export const DEMO_SELECTED_AREA: SelectedArea = {
  ...
  confidence: 90,
  affectedArea: "49.03 km²",
  explanation:
    "Sentinel-2 Level-2A multi-temporal NDWI water body analysis across Sardar Sarovar Reservoir.",
}
...
export function getMockAnalysis(area: SelectedArea): AnalysisResponse {
  ...
  if (area.analysisType === "urban" || area.analysisType === "infrastructure") {
    ...
    return {
      ...
      severity: (area.confidence ?? 90) >= 90 ? "High" : "Medium",
      ...
      findings: [
        {
          text: `Built-up area expanded from ${builtBefore} km² to ${builtAfter} km² — a ${pct}% increase over the analysis period.`,
          type: "critical",
        },
      ...
      timeline: [
        {
          date: area.afterDate,
          label: "Post-expansion scan complete",
          type: "scan",
        },
        {
          date: `${yearTo}-04-01`,
          label: "Urban growth alert issued",
          type: "alert",
        },
        {
          date: `${yearTo}-01-01`,
          label: "Annual ISA baseline update",
          type: "baseline",
        },
        {
          date: `${yearFrom}-06-01`,
          label: "Mid-period reference captured",
          type: "reference",
        },
        {
          date: area.beforeDate,
          label: "Pre-expansion baseline established",
          type: "baseline",
        },
      ],
    }
  ...
  if (area.analysisType === "water") {
    ...
    return {
      ...
      findings: [
        {
          text: `Water surface reduced from ${waterBefore} km² to ${waterAfter} km² — a ${pct}% decline over the analysis period.`,
          type: "critical",
        },
        { text: area.explanation, type: "warning" },
        {
      ...
      timeline: [
        {
          date: area.afterDate,
          label: "Post-monsoon water-level scan",
          type: "scan",
        },
        {
          date: `${yearTo}-06-01`,
          label: "Water recession alert issued",
          type: "alert",
        },
        {
          date: `${yearTo}-01-01`,
          label: "Annual NDWI baseline update",
          type: "baseline",
        },
        {
          date: `${yearFrom}-06-01`,
          label: "Pre-monsoon reference captured",
          type: "reference",
        },
        {
          date: area.beforeDate,
          label: "High-water baseline established",
          type: "baseline",
        },
      ],
    }
  ...
  if (area.analysisType === "vegetation-gain") {
    ...
    return {
      ...
      findings: [
        {
          text: `Canopy cover increased from ${vegBefore} km² to ${vegAfter} km² — a ${pct}% gain over the analysis period.`,
          type: "ok",
        },
      ...
      timeline: [
        {
          date: area.afterDate,
          label: "Post-growth season scan",
          type: "scan",
        },
        {
          date: `${yearTo}-04-01`,
          label: "Positive NDVI trend confirmed",
          type: "baseline",
        },
        {
          date: `${yearTo}-01-01`,
          label: "Annual NDVI baseline",
          type: "baseline",
        },
        {
          date: `${yearFrom}-06-01`,
        ...
        {
          date: area.beforeDate,
          label: "Pre-growth baseline established",
          type: "baseline",
        },
      ],
    }
  ...
  return {
    ...
    severity:
      (area.confidence ?? 90) >= 95
        ? "Critical"
        : (area.confidence ?? 90) >= 85
          ? "High"
          : "Medium",
    beforeLabel: "Canopy Cover (Before)",
    beforeValue: `${vegBefore} km²`,
    ...
    findings: [
      {
        text: `Canopy cover declined from ${vegBefore} km² to ${vegAfter} km² — a ${pct}% loss over the analysis period.`,
        type: "critical",
      },
      { text: area.explanation, type: "warning" },
      {
    ...
    timeline: [
      ...
      {
        date: `${yearTo}-03-15`,
        label: "Vegetation loss alert issued",
        type: "alert",
      },
      {
        date: `${yearTo}-01-01`,
      ...
      {
        date: area.beforeDate,
        label: "Healthy canopy baseline established",
        type: "baseline",
      },
    ],
  }
