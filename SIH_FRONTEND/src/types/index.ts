...
export type AnalysisType = "urban" | "water" | "vegetation-loss" | "vegetation-gain" | "infrastructure"
...
export interface SelectedArea {
  ...
  sensor: string
  confidence?: number // optional, no fake confidence
...
export interface AnalysisResponse {
  ...
  // ── Real Sentinel-2 raster calculation fields ───────────────────────────────
  ...
  beforeVisualUrl?: string
  afterVisualUrl?: string
}
